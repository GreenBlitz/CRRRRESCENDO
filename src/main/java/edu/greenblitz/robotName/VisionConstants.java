...
public class VisionConstants {
	...
	public static final String OBJECT_DETECTION_LIMELIGHT_NAME = "limelight-back";
	...
	public static final int TIMESTAMP_FACTOR = 1000;

	public static int DEFAULT_NETWORKTABLE_VALUE = -1;
	...
	public final static double APRIL_TAG_HEIGHT_CM = 0.18;

	public final static double APRIL_TAG_HEIGHT_TOLERANCE_CM = 0.04;
