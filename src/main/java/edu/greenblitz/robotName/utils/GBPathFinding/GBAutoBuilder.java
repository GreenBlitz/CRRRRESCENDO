...
public class GBAutoBuilder {
    ...
    /**
     * Configures the GBAutoBuilder with custom path following command builder. Building pathfinding
    ...
    /**
     * Returns whether the GBAutoBuilder has been configured.
     *
     * @return true if the GBAutoBuilder has been configured, false otherwise
     */
    ...
    /**
     * Returns whether the GBAutoBuilder has been configured for pathfinding.
     *
     * @return true if the GBAutoBuilder has been configured for pathfinding, false otherwise
     */
     ...
     * @throws AutoBuilderException if the GBAutoBuilder has not been configured
