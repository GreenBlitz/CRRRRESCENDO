...
public class GBPathPlannerAuto extends Command {
    ...
    public GBPathPlannerAuto(String autoName) {
        ...
        this.autoCommand = GBAutoBuilder.buildAuto(autoName);
        m_requirements = autoCommand.getRequirements();
        setName(autoName);
        GBPPLibTelemetry.registerHotReloadAuto(autoName, this);
    ...
    public void hotReload(JSONObject autoJson) {
        autoCommand = GBAutoBuilder.getAutoCommandFromJson(autoJson);
        m_requirements = autoCommand.getRequirements();
    }
