...
public class Field {
    ...
    public static class ScoringPositions{
        public final static Pose2d SPEAKER_SCORE_POSITION = new Pose2d(new Translation2d(14.140,5.994),new Rotation2d());
        public final static Pose2d AMP_SCORE_POSITION = new Pose2d(new Translation2d(15.292,8.226),new Rotation2d());
        public final static Pose2d CLIMB_POSITION = new Pose2d(new Translation2d(12.833,3.702),new Rotation2d());
    }
}
