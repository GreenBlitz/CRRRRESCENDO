...
public class ElbowConstants {
    ...
    public enum PresetPositions {
        SAFE(Rotation2d.fromDegrees(-45)),
    ...
    public static final Rotation2d BACKWARD_ANGLE_LIMIT = Rotation2d.fromDegrees(-65);
    ...
    public static final double GEAR_RATIO = 1 / (28 * (60 / 16.0));
