...
public class SimulationPivotConstants {
    ...
    public static final double GEAR_RATIO = 1 / 0.0328;

    //public static final double GEAR_RATIO = 1 / FalconPivotConstants.FEEDBACK_CONFIGS.SensorToMechanismRatio; TODO - NEED TO CALCULATE PID FOR THIS
