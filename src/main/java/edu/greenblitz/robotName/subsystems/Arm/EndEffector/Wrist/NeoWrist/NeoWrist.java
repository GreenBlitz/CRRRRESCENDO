package edu.greenblitz.robotName.subsystems.Arm.EndEffector.Wrist.NeoWrist;
...
public class NeoWrist implements IWrist {
    ...
    public void updateInputs(WristInputsAutoLogged inputs) {
        ...
        inputs.isObjectInside = debouncer.calculate(motor.getReverseLimitSwitch(NeoWristConstants.SWITCH_TYPE).isPressed());
    }
