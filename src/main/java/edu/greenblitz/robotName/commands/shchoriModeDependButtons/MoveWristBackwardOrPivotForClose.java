...
import edu.greenblitz.robotName.commands.shooter.pivot.MovePivotToAngleUntilInterrupted;
...
public class MoveWristBackwardOrPivotForClose extends ConditionalCommand {
	...
	public MoveWristBackwardOrPivotForClose(){
		super(
				new MovePivotToAngleUntilInterrupted(PivotConstants.PresetPositions.CLOSE_SHOOTING),
